...
I usually don't use Japanese prefixes when _talking_ in english, but just "Osage" is a bit weird lol. As it just means "twintails"
...
It being "spelt with hiragana" could mean the person is trying to express it in very simple terms, so that even a child could understand what they mean.
